...
from maketrains.mappoLSTM_discrete_combine import (
    make_train_combine_vsbaseline as make_train_mappoLSTM_discrete,
    save_model as save_train_mappoLSTM_discrete,
)
