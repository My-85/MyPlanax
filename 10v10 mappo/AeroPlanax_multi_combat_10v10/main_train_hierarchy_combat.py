...
# from envs.aeroplanax_combat_hierarchy_new import (
...
# Updated dimensions for new action space: [pitch, heading/yaw, velocity]
PPO_DISCRETE_HIERARCHY_DEFAULT_DIMS = [31, 31, 31]  # [pitch(31), heading(31), velocity(31)]
