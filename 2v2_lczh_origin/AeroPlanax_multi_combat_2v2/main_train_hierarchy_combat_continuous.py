...
config = {
    ...
    "WANDB": True,
    "TRAIN": True,
    "WANDB_API_KEY" : "f4316927feb010654a1d429360c2f2c824e84387", # Replace with your API key
...
if config["WANDB"]:
    if config["WANDB_API_KEY"] == "f4316927feb010654a1d429360c2f2c824e84387":
    ...
    wandb.init(
        project="AeroPlanax",
        config=config,
        name=f'continuous_mappo_seed_{config["SEED"]}',
        group=Env.__name__,
