    ...
    def __init__(self, env_params: Optional[HierarchicalCombatTaskParams] = None):
        ...
        self.reward_functions = [
            ...
            functools.partial(heading_alignment_reward_fn,  # 新添加的奖励函数
                              ...
                              num_allies=env_params.num_allies,
                              num_enemies=env_params.num_enemies),
            functools.partial(locked_penalty_fn, penalty_value=-5.0, num_allies=env_params.num_allies),
            functools.partial(tactical_position_reward_fn, 
                              reward_scale=1.0, 
                              num_allies=env_params.num_allies, 
                              num_enemies=env_params.num_enemies),
            functools.partial(crash_penalty_fn_new, penalty_value=-500.0),
            ...
            functools.partial(custom_event_driven_reward_fn, 
                              fail_reward=-500.0, 
                              narrow_victory_reward=50.0,
                              normal_victory_reward=100.0,
                              great_victory_reward=200.0,
                              complete_victory_reward=500.0),
